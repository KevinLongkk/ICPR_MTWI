...
def get_data(data_size, batch_size=cfg.BATCH_SIZE, test=False):

    images = np.zeros((batch_size, cfg.IMAGE_SIZE, cfg.IMAGE_SIZE, 3), np.float32)
    labels = np.zeros((batch_size, cfg.CELL_SIZE, cfg.CELL_SIZE, 9), np.float32)
    if data_size == 1000:
        ...
        try:
            ...
            with open(txt_path) as f:
                ...
                for line in lines:
                    ...
                    cell_center_x = (c_x + 0.5) * cfg.IMAGE_SIZE / cfg.CELL_SIZE
                    cell_center_y = (c_y + 0.5) * cfg.IMAGE_SIZE / cfg.CELL_SIZE
                    # print('center_x', cell_center_x)
                    # print('center_y', cell_center_y)
